...
def main(arg):
    ...
    if response.status_code == 200:
        ...
        response = requests.get(url, auth=authtw)
    ...
    tweet_stock_append(tweet_type, tweet_id, data[0]['id_str'], \
        data[0]['user']['name'], data[0]['user']['screen_name'], \
        level, data[0]['created_at'], data[0]['full_text'])
    ...
    if data[0]['is_quote_status']:
        ...
        tweet_stock_append(tweet_type, tweet_id, data[0]['quoted_status']['id_str'], \
            data[0]['quoted_status']['user']['name'], data[0]['quoted_status']['user']['screen_name'], \
            level, data[0]['quoted_status']['created_at'], data[0]['quoted_status']['full_text'])
